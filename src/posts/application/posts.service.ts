...
import {CommentOutput} from "../../coments/routers/output/comment.output";
...
export const postsService = {
    ...
    async findCommentsByPost(
        ...
        //     items: rawComments,
        //     totalCount
        // } = await postsRepository.findCommentsByPost(paginationDto, post._id.toString());
        // const items = await Promise.all(
        //     rawComments.map(comment => mapToCommentOutputUtil(comment, userId))
        // );
